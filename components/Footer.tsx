      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
          <div className="md:col-span-2">
            <Link to="/" className="text-3xl font-extrabold tracking-tighter text-sixsen-offwhite mb-6 block font-bruno">
          ...
          <div>
            ...
            <ul className="flex gap-4">
              <li>
                <a
                  href="https://api.whatsapp.com/send/?phone=5551999516231&text=Ol%C3%A1%21+Gostaria+de+saber+mais+sobre+os+servi%C3%A7os+da+Sixsen."
                  target="_blank"
                  rel="noopener noreferrer"
                  className="p-2 bg-sixsen-offwhite/5 rounded-full hover:bg-sixsen-orange/20 transition-all block"
                  aria-label="WhatsApp"
                >
                  <svg
                    ...
                    viewBox="0 0 24 24"
                    fill="currentColor"
                    className="text-sixsen-offwhite"
                  >
        ...
        <div className="pt-8 border-t border-sixsen-offwhite/5 text-center md:text-left flex flex-col md:flex-row justify-between items-center gap-4 text-xs text-sixsen-gray uppercase tracking-widest">
          <p>© 2026 <span className="font-bruno">Sixsen</span>. Todos os direitos reservados.</p>
